...
if [ "$1" == "16" ]; then
  ...
  docker run -it --rm -p 8000:8000 -v "$(pwd)/src:/src" amazoncorretto:$1-alpine-full /bin/sh -c "cd /src/java$1;ls;pwd;export JAVA_OPTS='--enable-preview --source 11';export PS1='$ ';java -version;exec /bin/sh"
fi
